...
namespace Ecart.Controllers
{
    public class ProductManageController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductID,ProductName,Price,ImageUrl")] tblproduct product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,ProductName,Price,ImageUrl")] tblproduct product)
        {
            if (ModelState.IsValid)
            {
